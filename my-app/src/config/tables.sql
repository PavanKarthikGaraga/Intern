...
CREATE TABLE uploads (
    ...
    day1Verified BOOLEAN DEFAULT NULL,
    day2Verified BOOLEAN DEFAULT NULL,
    day3Verified BOOLEAN DEFAULT NULL,
    day4Verified BOOLEAN DEFAULT NULL,
    day5Verified BOOLEAN DEFAULT NULL,
    day6Verified BOOLEAN DEFAULT NULL,
    day7Verified BOOLEAN DEFAULT NULL,
    day8Verified BOOLEAN DEFAULT NULL,
    day9Verified BOOLEAN DEFAULT NULL,
    day10Verified BOOLEAN DEFAULT NULL,
    createdAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (id),
